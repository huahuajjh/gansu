...
<title>FineCMS-<?php echo lang('a-msg-0'); ?></title>
<style type="text/css">
<!--
body {
...
.showMsg{
	background-color: #fff;
	border: 1px solid #e4ecf7; zoom:1; width:450px; height:172px;position:absolute;top:44%;left:50%;margin:-87px 0 0 -225px
}
.showMsg h5{
